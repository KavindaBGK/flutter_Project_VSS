...
class WeatherAdaptationHotControl extends StatefulWidget {
  @override
  _WeatherAdaptationControlState createState() =>
      _WeatherAdaptationControlState();
}

class _WeatherAdaptationControlState
    extends State<WeatherAdaptationHotControl> {
                ...
                child: BackdropFilter(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Advanced Weather Adaption for Heating",
                          style: TextStyle(
                            fontSize: 32,
